...
def main(parameters, species_list_use):
    solid = solidPhase()
    ...
    # Reference: Beckstead et al. Progress in energy science and combustion 33 (2007) 497-551
    dHphase = 2.35 
    integral_Cp_dt = (4.980e-2 * (Tbeta2delta - Tinit) +
                      0.660e-3 * ((Tbeta2delta ** 2) - (Tinit ** 2)) / 2.0)
...
#        integral_Cp_dt += dHmelting * 1000 / MW * s['normalized_content']
        integral_Cp_dt += dHphase * 1000 / MW
    print(MW)
